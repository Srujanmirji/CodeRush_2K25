...
const criteria = [
  { id: 1, title: 'Frontend UI/UX & Vibe', weight: '30%', icon: <Layers className="w-6 h-6" />, color: 'bg-cyber-pink', shadow: 'shadow-[0_0_20px_#ff00ff]' },
  { id: 2, title: 'Backend Logic & Functionality', weight: '25%', icon: <Lightbulb className="w-6 h-6" />, color: 'bg-cyber-blue', shadow: 'shadow-[0_0_20px_#00f0ff]' },
  { id: 3, title: 'Problem Solving & Usefulness', weight: '20%', icon: <Smartphone className="w-6 h-6" />, color: 'bg-cyber-purple', shadow: 'shadow-[0_0_20px_#7000ff]' },
  { id: 4, title: 'Animations & Effects', weight: '15%', icon: <Zap className="w-6 h-6" />, color: 'bg-yellow-400', shadow: 'shadow-[0_0_20px_#facc15]' },
  { id: 5, title: 'Performance & Innovation', weight: '10%', icon: <Code2 className="w-6 h-6" />, color: 'bg-green-400', shadow: 'shadow-[0_0_20px_#4ade80]' },
];
